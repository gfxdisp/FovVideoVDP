...
% specify rec2020. 
[Q_JOD_noise, diff_map_noise] = fvvdp( I_test_noise, I_ref, 'display_name', 'sdr_4k_30', 'display_photometry', 'absolute', 'heatmap', 'threshold' );
[Q_JOD_blur, diff_map_blur] = fvvdp( I_test_blur, I_ref, 'display_name', 'sdr_4k_30', 'display_photometry', 'absolute', 'heatmap', 'threshold' );
